...
Eigen::VectorXf GCC_PHAT_FFTW_E(Eigen::MatrixXcf& savedFFTs, fftwf_plan& ip1, const int& interp, int& channelSize, unsigned int& NUM_CHAN, const unsigned int& SAMPLE_RATE);

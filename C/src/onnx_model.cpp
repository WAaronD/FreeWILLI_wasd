...
ONNXModel::ONNXModel(const std::string& model_path, const std::string& scaler_params_path) {
...
std::vector<int64_t> ONNXModel::get_input_node_info() {
...
void ONNXModel::load_scaler_params(const std::string& file_path) {
...
std::vector<float> ONNXModel::run_inference(std::vector<float>& input_tensor_values) {
...
void ONNXModel::normalize_data(std::vector<float>& data) const {
